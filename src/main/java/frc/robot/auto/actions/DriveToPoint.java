...
public class DriveToPoint implements Action {
    ...
    public DriveToPoint(double x, double y, double theta, double minVelocity, double maxVelocity, double absTurnMax, double epsilon,
    ...
    public void update() {
        ...
        SmartDashboard.putNumber("desired Turn", desiredTurnValue);
        ...
        double dist = (yError);
        isFinished = Math.abs(dist) < this.epsilonDistance;
    }
