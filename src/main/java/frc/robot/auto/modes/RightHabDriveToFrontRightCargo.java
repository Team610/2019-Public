 ...
 */
public class RightHabDriveToFrontRightCargo extends AutoBase {
        ...
        runAction(
            new SeriesAction(Arrays.asList(
                new ParallelAction(Arrays.asList(
                        ...
                        new DriveToPointFinalHeadingControl(-0.7, 2, 91, -0.2, 0.4, 0.5, 0.05, 2, 25, true, 90),
                ...
                //     new WaitAction(0.1),
                //     new SetArmFlagAction("CEN"),
                //     new SetDrivePosition(new Point(0,0, RobotStateEstimator.getInstance().getCurrentPose().getTheta())),
                //     new DriveToPointFinalHeadingControl(-0.3, 0, 90, -0.4, 0.1, 0.5, 0.05, 2, 25, true, 90)
                // ))
